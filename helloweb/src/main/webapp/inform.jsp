...
<div style="color: black;width: 100%;text-align: center;margin-top: 30px;font-size: 35px">${informNews.title}</div>
<div style="color: black;width: 100%;text-align: center;font-size: 30px">${informNews.date}</div>
<div style="color: black;width: 60%;text-align: center;font-size: 26px;margin-left: 305px;height: auto">${informNews.content}</div>
</body>
</html>
