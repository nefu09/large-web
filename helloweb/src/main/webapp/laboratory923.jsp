...
<div class="content">
    <div class="aside">
         <div><img src="resources/img/aside1.png" style="margin-top: 180px;margin-right: 20px"></div>
         <div><img src="resources/img/aside2.png" style="margin-top: 60px;margin-right: 20px"></div>
         <div><img src="resources/img/aside3.png" style="margin-top: 60px;margin-right: 20px"></div>
    </div>
    <div class="right">
        <div class="up">
            <h1 style="margin-left:550px;font-size: 40px;padding-top: 60px">923实验室</h1>
        </div>
        <div class="middle">
            <div class="lun">
                <div id="circle1" class="circle"><img src="resources/img/92301.png" ></div>
                <div id="circle2" class="circle"><img src="resources/img/92302.png" ></div>
                <div id="circle3" class="circle"><img src="resources/img/92303.png" ></div>
                <div id="circle4" class="circle"><img src="resources/img/92304.png" ></div>
                <img id="img1" class="img" src="resources/img/92301.png">
                <img id="img2" class="img" src="resources/img/92302.png">
                <img id="img3" class="img" src="resources/img/92303.png">
                <img id="img4" class="img" src="resources/img/92304.png">
            </div>
        </div>
        <div class="down">
